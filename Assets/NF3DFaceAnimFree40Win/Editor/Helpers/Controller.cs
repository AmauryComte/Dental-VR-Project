    ...
    internal class Controller
    {
        ...
        private static Animatable BuildAvatarFromFrontImage()
        {
            ...
            try
            {
                ...
                List<System.Drawing.Point> ptList = new List<System.Drawing.Point>();
                ...
                foreach (PickedPoint pickedFrontPt in _frontImagePickedPts)
                {
                    ...
                    System.Drawing.Point pt = new System.Drawing.Point(xCord, yCord);

                    ptList.Add(pt);
                }

                System.Drawing.Point[] pointLocations = ptList.ToArray();
