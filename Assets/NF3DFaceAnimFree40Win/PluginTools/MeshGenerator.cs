...
namespace Assets.Scripts.NFScript
{
    ...
    public class MeshGenerator
    {
        ...
        const string TextureFolder = "Assets/NF3DFaceAnimFree40Win/_Textures/";
        const string MaterialsFolder = "Assets/NF3DFaceAnimFree40Win/_Materials/";
        ...
        public MeshGenerator()
	    {
            ...
            {
#if UNITY_EDITOR
                AnimatableMeshPrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/NF3DFaceAnimFree40Win/_Prefabs/AnimatableMesh.prefab", typeof(GameObject));

                EyeLeftPrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/NF3DFaceAnimFree40Win/_Prefabs/eyeLeft.prefab", typeof(GameObject));
                EyeRightPrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/NF3DFaceAnimFree40Win/_Prefabs/eyeRight.prefab", typeof(GameObject));
#endif
            }
